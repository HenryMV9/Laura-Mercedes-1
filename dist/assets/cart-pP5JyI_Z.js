import{g as y,b as $,c as P,u as q,r as T}from"./cart-DaXgv_wZ.js";import{c as S}from"./supabase-client-boJWN7_a.js";import{f as r,i as M,c as A}from"./currency-selector-D4CMqF52.js";const b=document.getElementById("cartItems"),C=document.getElementById("subtotal"),E=document.getElementById("total"),n=document.getElementById("proceedToCheckout"),l=document.getElementById("checkoutModal"),I=document.getElementById("closeCheckoutModal"),p=document.getElementById("quickCheckoutForm"),k=document.getElementById("modalSubtotal"),w=document.getElementById("modalTotal"),B=5e3;function d(){const t=y();if(t.length===0){b.innerHTML=`
