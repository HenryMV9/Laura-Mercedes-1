import{g as y,b as w,f as r,c as P,u as q,r as T}from"./cart-CPXUeT1p.js";import{c as M}from"./supabase-client-plvbIh6d.js";const b=document.getElementById("cartItems"),C=document.getElementById("subtotal"),E=document.getElementById("total"),n=document.getElementById("proceedToCheckout"),d=document.getElementById("checkoutModal"),I=document.getElementById("closeCheckoutModal"),p=document.getElementById("quickCheckoutForm"),k=document.getElementById("modalSubtotal"),$=document.getElementById("modalTotal"),x=5e3;function l(){const t=y();if(t.length===0){b.innerHTML=`
